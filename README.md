...
│   │   ├── Controllers/
│   │   │   ├── Admin/
│   │   │   │   ├── StaffController.php       # RBAC & Personnel management
│   │   │   │   └── ServiceController.php     # Laundry catalog & Add-on management
│   │   │   ├── Auth/                         # Laravel Breeze authentication controllers
│   │   │   ├── Controller.php                # Base Laravel controller
│   │   │   ├── DashboardController.php       # Role-based data aggregation for stats
│   │   │   ├── OrderController.php           # Core booking & operational lifecycle
│   │   │   └── ProfileController.php         # User account & security settings
│   │   ├── Middleware/                       # Route guards (Spatie & Auth)
│   │   └── Requests/
│   │       ├── Admin/
│   │       │   ├── StoreAddonRequest.php     # Validation for premium utility extras
│   │       │   └── StoreServiceRequest.php   # Validation for core laundry categories
│   │       ├── StoreOrderRequest.php         # Logic-aware order validation
│   │       └── UpdateStatusRequest.php       # Staff-only operational updates
│   ├── Models/                               # Eloquent entities
│   │   ├── User.php                          # Identity with Spatie HasRoles trait
│   │   ├── Order.php                         # Main transaction (w/ Global Security Scope)
│   │   ├── MainService.php                   # Service definitions (KG vs Piece)
│   │   ├── AddOn.php                         # Premium extras (Multiple allowed)
│   │   ├── LaundryStatus.php                 # 6-Stage protocol tracking
│   │   ├── LaundryStatusAudit.php            # Immutable logs (Trigger-based)
│   │   ├── Collection.php                    # Intake logistics
│   │   ├── Delivery.php                      # Return logistics & scheduling
│   │   └── Payment.php                       # Financial settlement status
│   ├── Policies/                             # Authorization gates (OrderPolicy.php)
│   ├── Providers/                            # System booting & AppServiceProvider
│   └── Services/
│       └── OrderProcessingService.php        # Business Layer: Pricing & Auto-provisioning
├── bootstrap/                                # App booting & Middleware aliases
├── config/                                   # App, Database, & Permission configs
├── database/
│   ├── migrations/                           # DB Schemas, MySQL Triggers & Procedures
│   └── seeders/
│       ├── DatabaseSeeder.php                # Master seeder entry point
│       ├── RolesAndPermissionsSeeder.php     # RBAC initialization (Admin, Staff, Customer)
│       └── OrderLifecycleSeeder.php          # 14 Simulated operational dummy orders
├── public/                                   # Compiled assets & Entry point
├── resources/
│   ├── css/                                  # Tailwind CSS source
│   ├── js/                                   # Alpine.js & Frontend logic
│   └── views/
│       ├── welcome.blade.php                 # DETAILED: Public Landing Page
│       │                                     # - Direct access to Public Service Catalog
│       │                                     # - Authenticated user redirection
│       │                                     # - System branding and Guest CTA
│       ├── admin/                            # Staff & Service management views
│       ├── components/                       # Atomic UI (Stat cards, badges, buttons)
│       ├── dashboard/                        # Admin/Staff vs Customer dashboards
│       ├── layouts/                          # Master App & Navigation layouts
│       ├── orders/                           # Booking forms & Real-time tracking modals
│       └── profile/                          # User setting forms
├── routes/
│   ├── auth.php                              # Breeze authentication routes
│   └── web.php                               # Main application operational routes
├── vendor/                                   # Composer dependencies (Spatie, Breeze)
├── .env                                      # Environment & Database variables
