...
return new class extends Migration {
    public function up(): void {
        // Only run this if the connection is NOT sqlite
        ...
        // 2. Automated History Tracking (MySQL Syntax)
        DB::unprepared("
        ...
        // View is generally supported in SQLite, but syntax varies
        DB::unprepared("
            CREATE OR REPLACE VIEW vw_order_summary AS
            SELECT o.id AS order_id, u.name AS customer_name, o.total_price, 
                o.order_status, ls.current_status AS laundry_stage,
                p.payment_status, o.created_at
            FROM orders o
